<?php 
    ...
    if (isset($_POST['btnCadastrar'])) {
        $Medicos->cadastrar($_POST);
    }
    if (isset($_POST['btnEditar'])) {
        $Medicos->editar($_POST);
    }
    if (isset($_POST['btnDesativar'])) {
        $Medicos->desativar($_POST['id_medico'],$_SESSION['usuario_logado']);
    }
?>
...
<head>
    ...
    <title>GRNacoes - Gerenciar Médicos</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Médicos Ativos | <button class="btn btn-primary" data-toggle="modal" data-target="#modalCadastrarMedico" class="collapse-item" data-usuario_logado="<?php echo $_SESSION['id_usuario'] ?>">Cadastrar Novo Médico</button> | <button class="btn btn-secondary">Ver Médicos Desativados</button></h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-secondary collapse-item" data-toggle="modal" data-target="#modalEditarMedico"><i class="fa-solid fa-gear"></i></button>
                                                <button class="btn btn-danger collapse-item" data-toggle="modal" data-target="#modalDesativarMedico"><i class="fa-solid fa-power-off"></i></button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
...
<!-- Page level plugins -->
<script src="<?php echo URL ?>/vendor/datatables/jquery.dataTablesMedicos.js"></script>
