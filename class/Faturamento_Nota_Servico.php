...
class Faturamento_Nota_Servico
{
    ...
    {
        $sql = $this->pdo->prepare('SELECT * FROM faturamento_notas_servicos INNER JOIN convenios ON faturamento_notas_servicos.id_convenio = convenios.id_convenio WHERE faturamento_notas_servicos.deleted_at IS NULL AND faturamento_notas_servicos.id_competencia = :id_competencia ORDER BY convenios.convenio ASC');
