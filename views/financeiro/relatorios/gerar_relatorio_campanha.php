...
require 'vendor/autoload.php';
 ...
 $Campanhas = new Financeiro_Campanha();
...
{    
    ...
    $sheet->setCellValue('E7', "NÃO CONVERTIDAS (2%)");
    $sheet->setCellValue('F7', "NÃO CONVERTIDAS (%)");
    $sheet->setCellValue('G7', "COMISSÃO (2%)");
...
{    
    ...
    $sheet->setCellValue('E'.$row, "NÃO CONVERTIDAS (2%)");
    $sheet->setCellValue('F'.$row, "NÃO CONVERTIDAS (%)");
    $sheet->setCellValue('G'.$row, "COMISSÃO (2%)");
...
$filename = "resumo_campanha_$n_campanha.xlsx";
