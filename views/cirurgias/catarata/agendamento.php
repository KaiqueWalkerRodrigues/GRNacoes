                                        ...
                                        <?php foreach($Catarata_Agendamento->listar() as $agendamento){ ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                     <a class="btn btn-datatable btn-icon btn-transparent-dark 2" target="_blank" href="documentos/gerar_contrato_pdf?id_paciente=<?php echo $agendamento->id_catarata_agendamento ?>&nome_paciente=<?php echo $agendamento->nome ?>">
