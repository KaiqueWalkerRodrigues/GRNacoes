...
async function marcarTodasComoLidas() {
  ...
  try {
    ...
    // Dispara requisições em paralelo, UM id_notificacao por vez
    const promises = ids.map(id => {
      ...
      return fetch(`${URL_BASE}/views/ajax/set_notificacoes_lida.php`, {
        ...
        // Mesmo que venha 400/500, tentamos ler o JSON para mensagem
        let json = null;
    ...
    if (window.toastr?.success) toastr.success('Notificações marcadas como lidas!');
    else alert('Notificações marcadas como lidas!');
